...
class Action_GetStockoutByIdApi extends Order_Base_ApiAction
{
    /**
     * input params
     * @var array
    ...
    public function myConstruct()
    {
        ...
        $this->objPage = new Service_Page_Stockout_Api_GetStockoutByIdApi();
    }
...
//            'stockout_create_time' => empty($arrRet['create_time']) ? 0 : date('Y-m-d H:i:s', $arrRet['create_time']),
            'stockout_update_time' => empty($arrRet['update_time']) ? 0 : date('Y-m-d H:i:s', $arrRet['update_time']),
...
//            'customer_id' => empty($arrRet['customer_id']) ? 0 : strval($arrRet['customer_id']),
