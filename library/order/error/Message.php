...
class Order_Error_Message extends Wm_Error_Message
{
    protected $_disp_app_err_msg = [
        ...
        Order_Error_Code::NWMS_ORDER_STOCKOUT_ORDER_REPEAT_SUBMIT => '重复创建出库单',
        Order_Error_Code::TIME_PARAMS_LESS_THAN_ONE => '至少要有一个时间传入参数',
        Order_Error_Code::MULTI_WAREHOUSE_QUERY_PLAN_TIME_REQUIRED => '多仓库查询需要预约入库时间范围',
        Order_Error_Code::SKU_UPC_OR_SKU_ID_LENGTH_EXCEPTION => '输入商品id或条码id长度异常',
        ...
        Order_Error_Code::ORDER_NOT_IN_GIVEN_WAREHOUSE => '该单据不在该仓库中',
...
//        Order_Error_Code::NWMS_ORDER_STOCKOUT_PICKUP_NOTICE_OMS_FAILED => '出库单拣货通知OMS失败',
        ...
        Order_Error_Code::PICKUP_ORDER_IS_FINISHED => '拣货单已完成',
