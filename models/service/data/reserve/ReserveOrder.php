...
//            'vendor_address' => strval($arrReserveOrder['vendor_address']),
    ...
    public function getReserveOrderPrintList($arrOrderIds)
    {
        ...
        $arrSkuColumns = ['reserve_order_id','upc_id','sku_name','sku_net','upc_unit','upc_min_unit','reserve_order_sku_plan_amount','stockin_order_sku_real_amount','sku_net_unit','stockin_order_sku_extra_info'];
